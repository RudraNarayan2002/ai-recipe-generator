  ...
  return (
    <div className="flex flex-col w-full max-w-2xl pt-12 pb-24 mx-auto">
      ...
      <form
        ...
        className="fixed bottom-0 w-full max-w-2xl mx-auto left-0 right-0 p-4 bg-zinc-50  border-t border-zinc-200  shadow-lg"
      >
        <div className="flex gap-2">
          <input
            ...
            className="flex-1  p-2 border border-zinc-300  rounded shadow-xl"
          />
          {isLoading ? (
            <button
              type="button"
